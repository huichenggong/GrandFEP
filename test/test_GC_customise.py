...
class MyTestCase(unittest.TestCase):
    def test_AmberFF(self):
        ...
        inpcrd = app.AmberInpcrdFile(base / "CH4_C2H6" /"lig0"/ "MOL_2wat.inpcrd")
        prmtop = app.AmberPrmtopFile(base / "CH4_C2H6" /"lig0"/ "MOL_2wat.prmtop",
                                     periodicBoxVectors = inpcrd.boxVectors)
        top_2wat = prmtop.topology
        sys_2wat = prmtop.createSystem(**nonbonded_settings)
        pos_2wat = inpcrd.positions
        energy_2wat, force_2wat = calc_energy_force(sys_2wat, top_2wat, pos_2wat, platform)
